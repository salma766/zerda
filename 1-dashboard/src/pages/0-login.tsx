...
function Login() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        const res = await apiClient.post<BackendResponse>('/api/auth/login',
            {
                "email": email,
                "password": password
            }
        ...
        if (res.data.status === 'success') {
            const loggedIn = signIn({ token: res.data.user!.token!, expiresIn: 10080, tokenType: "Bearer", authState: res.data.user! })
            if (loggedIn)
                navigate('/')
        } else {
                ...
                <div className="authentication-inner">
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <form onSubmit={handleSubmit} id="formAuthentication" className="mb-3" action="index.html" method="POST">
                                <div className="mb-3">
